<x-guest-layout>
    <form method="POST" action="{{ route('password.store') }}">
        ...
        <div class="mt-4">
            ...
            <div x-data="{show:false}" class="relative">
                <x-text-input id="password" type="password" x-bind:type="show ? 'text':'password'"
                    class="block mt-1 w-full pr-10" name="password" required autocomplete="new-password" />
        ...
        <div class="mt-4">
            ...
            <div x-data="{show:false}" class="relative">
                <x-text-input id="password_confirmation" type="password" x-bind:type="show ? 'text':'password'"
